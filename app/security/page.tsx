    ...
    <div className="bg-[#0a0a0a] min-h-screen" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
      ...
      <section className="pt-20 pb-16 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-semibold uppercase tracking-widest text-[#f59e0b] mb-4">Security</p>
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-4">Your data is safe with us</h1>
          <p className="text-xl text-[#b3b3b3]">We built ZiggyReviews for our own business first. Security was never optional.</p>
        </div>
      </section>
      <section className="py-12 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            {features.map((f) => (
              <div key={f.title} className="bg-[#111111] border border-[#1f1f1f] rounded-2xl p-6 hover:border-[#f59e0b]/30 transition-colors">
