...
export const metadata: Metadata = {
  title: "Changelog — ZiggyReviews",
  description: "What's new in ZiggyReviews. Feature updates, improvements, and release notes.",
}
    ...
    <>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1120, margin: "0 auto", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <a href="/" style={{ textDecoration: "none", fontSize: 22, fontWeight: 700, color: "#fff", letterSpacing: "-0.5px" }}>Ziggy<span style={{ color: ACCENT }}>Reviews</span></a>
          <div className="nav-links" style={{ display: "flex", gap: 28 }}>
            {[["Features", "/features"], ["Pricing", "/#pricing"], ["Contact", "/contact"], ["Blog", "/blog"], ["Sign In", "https://app.ziggyreviews.com/login"]].map(([l, h]) => (
              <a key={l} href={h} style={{ color: "#888", fontSize: 15, textDecoration: "none", fontWeight: 500 }}>{l}</a>
            ))}
          </div>
          <a href="https://app.ziggyreviews.com/signup" style={{ background: ACCENT, color: "#fff", textDecoration: "none", padding: "9px 20px", borderRadius: 8, fontSize: 14, fontWeight: 700 }}>
            Start Free Trial
          </a>
        </div>
      </nav>
        ...
        <div style={{ position: "relative", paddingLeft: 32 }}>
          ...
          <div style={{ position: "relative", marginBottom: 64 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
              <span style={{ background: `rgba(245,158,11,0.15)`, color: ACCENT, border: `1px solid rgba(245,158,11,0.3)`, borderRadius: 99, padding: "4px 12px", fontSize: 12, fontWeight: 700, letterSpacing: "0.05em" }}>v1.0.0</span>
            ...
            <div style={{ background: "#111", border: "1px solid #1f1f1f", borderRadius: 16, padding: "28px 28px 24px" }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: "#fff", marginBottom: 16 }}>🚀 ZiggyReviews is live</h3>
              <p style={{ fontSize: 14, color: "#666", marginBottom: 20, lineHeight: 1.6 }}>
                We've been building ZiggyReviews for months. Today it's open for everyone. Here's everything you get on day one:
              </p>
              <ul style={{ listStyle: "disc", paddingLeft: 20, display: "flex", flexDirection: "column", gap: 6 }}>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Automated review request campaigns via SMS and email"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Centralized inbox for Google and Facebook reviews"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Review response tools with customizable templates"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Embeddable review widget for your website"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Instant new-review alerts and notifications"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Google Business Profile direct integration"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Competitor reputation tracking"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Monthly reputation performance reports"}</li>
              </ul>
            </div>
          </div>
