...
const nativeIntegrations = [
  { name: `Google Business`, domain: `business.google.com`, desc: `Direct integration for review monitoring and response` },
  { name: `Twilio`, domain: `twilio.com`, desc: `SMS review request delivery` },
  { name: `Resend`, domain: `resend.com`, desc: `Email review request delivery` },
  { name: `Zapier`, domain: `zapier.com`, desc: `Trigger workflows based on new reviews` },
  { name: `Slack`, domain: `slack.com`, desc: `Get instant alerts when new reviews come in` },
]
const comingSoon = [
  { name: `TripAdvisor`, domain: `tripadvisor.com`, desc: `Monitor TripAdvisor reviews` },
  { name: `Trustpilot`, domain: `trustpilot.com`, desc: `Sync Trustpilot reviews to your dashboard` },
  { name: `OpenTable`, domain: `opentable.com`, desc: `Monitor OpenTable restaurant reviews` },
]
const suiteApps = [
    ...
    <div className="bg-[#0a0a0a] min-h-screen" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
      ...
      <section className="relative overflow-hidden pt-20 pb-20 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">Works with the tools <span className="text-[#f59e0b]">you already use</span></h1>
          <p className="text-xl text-[#b3b3b3] max-w-2xl mx-auto">ZiggyReviews connects natively with your favorite tools — and via Zapier, with 5,000+ more.</p>
        </div>
      </section>
      <section className="py-16 px-4 border-b border-[#2d2d2d]">
        <div className="max-w-7xl mx-auto">
          <span className="px-2.5 py-1 rounded-full bg-[#f59e0b]/10 border border-[#f59e0b]/20 text-[#f59e0b] text-xs font-medium">Native Suite</span>
      ...
      <section className="py-16 px-4 border-b border-[#2d2d2d]">
        <div className="max-w-7xl mx-auto">
          <span className="px-2.5 py-1 rounded-full bg-[#f59e0b]/10 border border-[#f59e0b]/20 text-[#f59e0b] text-xs font-medium mb-6 inline-block">Native Integrations</span>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {nativeIntegrations.map((i) => (
              <div key={i.name} className="bg-[#111111] border border-[#1f1f1f] rounded-xl p-5 hover:border-[#f59e0b]/30 transition-colors flex items-start gap-4">
                ...
                <div>
                  ...
                  <span className="inline-block mt-2 px-2 py-0.5 bg-[#f59e0b]/10 text-[#f59e0b] text-xs rounded-full">Native</span>
                </div>
              </div>
            ))}
          </div>
